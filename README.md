...
- **launchd agent missing after macOS update** — macOS occasionally resets per-user launchd state after a major OS update. `claude-multiacct repair` re-installs and re-loads all four agents.
